  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <ul class="nav align-items-center d-md-none">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
            ...
            <a href="<?= base_url(); ?>panitia/profile" class="dropdown-item">
              <i class="ni ni-single-02"></i>
              <span>My profile</span>
            </a>
            <a href="<?= base_url(); ?>panitia/setting" class="dropdown-item">
              <i class="ni ni-settings-gear-65"></i>
              <span>Settings</span>
            </a>
            <div class="dropdown-divider"></div>
            <a href="<?= base_url(); ?>panitia/logout" class="dropdown-item">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link <?php if($page == 'dashboard'){echo 'active';} ?>" href="<?= base_url(); ?>panitia">
              <i class="ni ni-tv-2 text-primary"></i> Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($page == 'profile'){echo 'active';} ?>" href="<?= base_url(); ?>panitia/profile">
              <i class="ni ni-single-02 text-yellow"></i> Profile
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($page == 'kegiatan'){echo 'active';} ?>" href="<?= base_url(); ?>panitia/kegiatan">
              <i class="ni ni-bullet-list-67 text-red"></i> Buat Kegiatan
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($page == 'list'){echo 'active';} ?>" href="<?= base_url(); ?>panitia/list">
              <i class="ni ni-pin-3 text-red"></i> List Kegiatan
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($page == 'peserta'){echo 'active';} ?>" href="<?= base_url(); ?>panitia/peserta">
              <i class="ni ni-pin-3 text-red"></i> List Peserta
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if($page == 'antrian'){echo 'active';} ?>" href="<?= base_url(); ?>panitia/antrian">
              <i class="ni ni-pin-3 text-red"></i> List Antrian
            </a>
          </li>
        </ul>
      </div>
