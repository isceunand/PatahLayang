...
<head>
  ...
  <title>Login Panitia Donor Darah</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">Login Panitia</h1>
            </div>
          </div>
        </div>
      </div>
              ...
              if(isset($_POST["login"])){
                ...
                if($query->num_rows() == 1){
                  ...
                  if(password_verify($password, $data->password)){
                    ...
                    $this->alert->mes("success", "Login Berhasil", "", 1, base_url("/panitia"));
                  }else{
                    $this->alert->mes("", "", "Password Salah");
                  }
                }else{
                  $this->alert->mes("", "", "Email tidak ditemukan");
                }
              } ?>
            </div>
          </div>
